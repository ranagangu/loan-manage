...
<body class="hold-transition login-page" style="background-image:url('img/login-backgroundpic.png'); background-repeat:no-repeat;">
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form class="form"  method="post" enctype="multipart/form-data">
	  ...
	  <div align="center">
		  ...
		  <hr>
      <a href="Documentation/" target="_blank">Click here to see our documentation</a>
	  </div>
<?php
